        ...
        <div className="col-md-6 mb-md-5">
          <div className="card shadow rounded">
            <div className="card-body">
              ...
              <p className="card-text fwCard  mt-2 ">
                We are constantly working on nymous as a platform to make it as
                user friendly as possible. As of now you can visit our website and fill in your username & pass to get started.
              </p>
            </div>
          </div>
        </div>
